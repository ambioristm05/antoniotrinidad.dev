    ...
    <article className="project-card">
      ...
      <div className="project-card__body">
        ...
        <div className="project-card__actions">
          <a className="button button--primary button--small" href={project.liveUrl} target="_blank" rel="noreferrer">
            {projectsPage.demo}
          </a>
          <a className="button button--secondary button--small" href={project.repoUrl} target="_blank" rel="noreferrer">
            {projectsPage.code}
          </a>
        </div>
      </div>
