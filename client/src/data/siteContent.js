...
function makeContent(language) {
  ...
  return {
    ...
    about: { eyebrow: es ? 'Sobre mí' : 'About', title: es ? 'Desarrollo interfaces y APIs con una obsesión tranquila por la claridad' : 'I develop interfaces and APIs with a calm obsession for clarity', description: es ? 'Me interesa el punto donde la experiencia, la arquitectura y el negocio se encuentran.' : 'I care about where experience, architecture and business meet.', resumeAction: es ? 'Descargar CV' : 'Download resume', paragraphs: es ? ['Soy Antonio Trinidad, desarrollador fullstack enfocado en aplicaciones MERN.', 'Trabajo con ciclos cortos, entregables visibles y bases técnicas mantenibles.'] : ['I am Antonio Trinidad, a fullstack developer focused on MERN applications.', 'I work with short cycles, visible deliverables and maintainable foundations.'] },
