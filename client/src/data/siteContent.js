...
function makeContent(language) {
  ...
  return {
    ...
    nav: { home: es ? 'Inicio' : 'Home', about: es ? 'Sobre mí' : 'About', projects: es ? 'Proyectos' : 'Projects', blog: 'Blog', contact: es ? 'Contacto' : 'Contact', privacy: es ? 'Privacidad' : 'Privacy', resume: es ? 'Descargar CV' : 'Download resume', primaryCta: es ? 'Hablemos' : "Let's talk", aria: es ? 'Navegación principal' : 'Main navigation' },
    ...
    profile: { ...sharedProfile, role: es ? 'Desarrollador Fullstack' : 'Fullstack Developer', shortRole: 'FullStack Developer', tagline: es ? 'Construyo aplicaciones modernas con Next.js y el ecosistema MERN, desde interfaces PWA hasta APIs y paneles privados.' : 'I build modern applications with Next.js and the MERN ecosystem, from PWA interfaces to APIs and private dashboards.', location: es ? 'San Pedro de Macorís, República Dominicana' : 'San Pedro de Macoris, Dominican Republic', metrics: es ? [{ label: 'frontend', value: 'React + Next.js' }, { label: 'backend', value: 'Node + Express' }, { label: 'datos', value: 'MongoDB' }] : [{ label: 'frontend', value: 'React + Next.js' }, { label: 'backend', value: 'Node + Express' }, { label: 'data', value: 'MongoDB' }] },
    home: { primaryAction: es ? 'Ver proyectos' : 'View projects', secondaryAction: es ? 'Contactar' : 'Contact me', resumeAction: es ? 'Descargar CV' : 'Download resume', terminal: `const product = {\n  frontend: ['Next.js', 'React', 'TypeScript'],\n  backend: ['Node.js', 'Express'],\n  data: 'MongoDB',\n  delivery: 'PWA to production'\n};`, featuredProjects: { eyebrow: es ? 'Proyectos destacados' : 'Featured projects', title: es ? 'Trabajo pensado para usuarios reales y equipos que necesitan avanzar' : 'Work shaped for real users and teams that need momentum', description: es ? 'Casos con problema, solución, stack y resultado.' : 'Cases with problem, solution, stack and outcome.' }, stack: { eyebrow: 'Stack', title: es ? 'Herramientas de trabajo' : 'Tools I work with', description: es ? 'Tecnologías para construir productos completos, accesibles y mantenibles.' : 'Technologies for building complete, accessible and maintainable products.' }, blog: { eyebrow: 'Blog', title: es ? 'Notas técnicas desde el proceso' : 'Technical notes from the process', description: es ? 'Artículos sobre arquitectura, frontend, backend y producto.' : 'Articles about architecture, frontend, backend and product.' } },
    about: { eyebrow: es ? 'Sobre mí' : 'About', title: es ? 'Desarrollo productos web completos, desde la experiencia hasta la arquitectura' : 'I build complete web products, from experience to architecture', description: es ? 'Conecto interfaces claras, APIs estructuradas y datos eficientes para crear soluciones con impacto real.' : 'I connect clear interfaces, structured APIs and efficient data to create solutions with real impact.', resumeAction: es ? 'Descargar CV' : 'Download resume', paragraphs: es ? ['Soy Antonio Trinidad, desarrollador Fullstack con experiencia en Next.js y el ecosistema MERN. Trabajo como freelance desde San Pedro de Macorís para clientes de los sectores religioso, educativo y de marcas personales.', 'Diseño soluciones completas: interfaces mobile-first y PWA con soporte offline, APIs REST, bases de datos y paneles de administración privados. Priorizo el código limpio, el rendimiento, la accesibilidad y el SEO técnico.', 'Trabajo mediante ciclos cortos y entregables visibles, con una separación clara entre interfaz, API, modelos, validaciones y servicios.'] : ['I am Antonio Trinidad, a Fullstack Developer experienced in Next.js and the MERN ecosystem. I work as a freelancer from San Pedro de Macoris for religious, educational and personal-brand clients.', 'I design complete solutions: mobile-first and offline-capable PWA interfaces, REST APIs, databases and private admin dashboards. I prioritize clean code, performance, accessibility and technical SEO.', 'I work through short cycles and visible deliverables, with clear boundaries between the interface, API, models, validation and services.'] },
    ...
    timeline: es ? [{ year: '2026', title: 'Portafolio fullstack y blog técnico', description: 'Plataforma propia con administración privada, autenticación, contenido y SEO técnico.' }, { year: '2025', title: 'Aplicaciones MERN orientadas a negocio', description: 'APIs, paneles administrativos, autorización por roles y flujos de trabajo.' }, { year: '2024', title: 'Formación en frontend moderno', description: 'React, JavaScript, formularios, diseño responsivo, accesibilidad y experiencia de usuario.' }] : [{ year: '2026', title: 'Fullstack portfolio and technical blog', description: 'A personal platform with private administration, authentication, content and technical SEO.' }, { year: '2025', title: 'Business-oriented MERN applications', description: 'APIs, admin dashboards, role-based authorization and workflows.' }, { year: '2024', title: 'Modern frontend training', description: 'React, JavaScript, forms, responsive design, accessibility and user experience.' }],
    admin: { nav: es ? ['Resumen', 'Proyectos', 'Posts', 'Comentarios', 'Categorías', 'Mensajes'] : ['Overview', 'Projects', 'Posts', 'Comments', 'Categories', 'Messages'], content: es ? 'Contenido' : 'Content', dashboard: 'Dashboard', dashboardTitle: es ? 'Resumen editorial' : 'Editorial overview', newContent: es ? 'Nuevo contenido' : 'New content', recentProjects: es ? 'Proyectos recientes' : 'Recent projects', recentPosts: es ? 'Posts recientes' : 'Recent posts', stats: es ? ['Proyectos', 'Posts', 'Mensajes', 'Borradores'] : ['Projects', 'Posts', 'Messages', 'Drafts'] },
  };
}
