...
function makePrivacy(language) {
  ...
  return {
    ...
    sections: [
      ...
      { title: 'Cookies', paragraphs: [es ? 'Este sitio puede utilizar cookies para mejorar la navegación y obtener estadísticas de uso.' : 'This site may use cookies to improve browsing and obtain usage statistics.'] },
...
function makeContent(language) {
  ...
  return {
    ...
    skills: ['React', 'Node.js', 'Express', 'MongoDB', 'Mongoose', 'REST APIs', 'Vite', es ? 'CSS moderno' : 'Modern CSS', 'JWT', 'Testing', es ? 'SEO técnico' : 'Technical SEO', es ? 'Accesibilidad' : 'Accessibility'],
