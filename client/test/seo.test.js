...
describe('SEO helpers', () => {
  it('builds consistent titles and canonical URLs', () => {
    ...
    assert.equal(buildCanonicalUrl('/blog/api-segura'), 'https://antoniotrinidad.dev/blog/api-segura');
  });

  it('resolves relative and absolute social images', () => {
    assert.equal(resolveSocialImage('/brand/cover.png'), 'https://antoniotrinidad.dev/brand/cover.png');
